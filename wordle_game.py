...
class WordleEnv:
    ...
    def render(self, mode='human', close=False):
        # If you want to print some information instead of graphical rendering
#         print(f"Current Step: {self.current_step}, Total Reward: {self.total_reward}")
#         # Or simply pass if you don't need any output
        pass
...
if __name__ == '__main__':
    ...
    # Initialize wandb with your project name and API key
    wandb.init(
    # set the wandb project where this run will be logged
    project="WordleTraining",
    ...
    for epoch in range(epochs):
        # Inside your training loop, after the epoch finishes:
        ...
        for k, v in sorted(right_in.items()):
            print(f'Guessed {v} in {k} attempts')

        # Calculate and print win rate
        win_rate = ep_correct / n_games if n_games > 0 else 0
        print(f'Win Rate: {win_rate:.2f} ({ep_correct}/{n_games})')

        # Log training metrics to wandb
       # Log win rate and total reward to wandb
        wandb.log({"Epoch": epoch, "Policy Loss": loss_pi.item(), "Value Loss": loss_v.item(), "Entropy": ent,
                   "Win Rate": win_rate, "Total Reward": ep_ret})
